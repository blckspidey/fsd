    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src={heroImage} alt="Ancient Temple" className="w-full h-full object-cover" />
        ...
        <div className="relative z-20 text-center px-4 max-w-5xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-parchment/90 font-body italic mb-12 animate-divine-reveal" style={{ animationDelay: "0.3s" }}>
            Step into the sacred echoes of ancient earth
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-divine-reveal" style={{ animationDelay: "0.6s" }}>
            <Link to="/trails">
              <Button
                size="lg"
      ...
      <div className="relative py-16 flex items-center justify-center">
        ...
        <div className="relative bg-background px-6">
          <img src={omSymbol} alt="Om Symbol" className="w-16 h-16 breathe opacity-80" />
        </div>
      </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-background to-card">
        <div className="container mx-auto max-w-7xl">
            ...
            {featuredTrails.map((trail, index) => (
              ...
              >
                <div className="relative h-64 overflow-hidden">
                  <img src={trail.image} alt={trail.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
                ...
                <div className="p-6 bg-card border-t-2 border-temple-gold/20">
                  ...
                  <p className="text-sm text-temple-gold/80 mb-3 font-nav tracking-wide">{trail.subtitle}</p>
                  <p className="text-parchment/70 text-sm font-body mb-4">{trail.description}</p>
                  <Link to="/trails">
                    <Button variant="ghost" size="sm" className="text-temple-gold hover:text-soft-gold hover:bg-soft-gold/10 transition-all group/btn">
                      Explore Trail
          ...
          <div className="text-center mt-12">
            <Link to="/trails">
              <Button size="lg" className="bg-card border-2 border-temple-gold/40 text-parchment shadow-temple hover:shadow-divine hover:border-temple-gold transition-all duration-500 glow-pulse font-nav tracking-wide">
      ...
      <section className="relative py-32 px-4 overflow-hidden">
        ...
        <div className="relative container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-parchment/80 font-body italic mb-12 animate-divine-reveal" style={{ animationDelay: "0.2s" }}>
